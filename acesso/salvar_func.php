...
if(@mysql_query("INSERT INTO inscritos (codigo,cpf,noticia) VALUES (NULL , '$cpf','MANUAL')")) {
	...
	if(mysql_affected_rows() == 1){
		...
		while($dados = mysql_fetch_array($re2)) {
			...
			mysql_query("INSERT INTO cliente_fornecedor VALUES ('$cod2' , UPPER('$nome') ,UPPER('$nome') , '$email','$telefone','$telefone2','$cpf', '$rg','$uf','$cidade','$endereco','$numero','$complemento', '$cep','$tipo','$curso','$turma')");
	}	
