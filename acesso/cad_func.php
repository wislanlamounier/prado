...
<div class="conteudo">
<center><strong><font size="+1">Cadastro de Funcionário</font></strong></center>
<hr />
<div class="container_12"><br />

                <form action="salvar_func.php" method="POST" onKeyPress="return arrumaEnter(this, event)">
                    ...
                    <div class="grid_12">
                        ...
                        <div class="grid_4">
                          ...
                          <input id="tipo" name="tipo" type="hidden" placeholder="TIPO" required onKeyPress="return arrumaEnter(this, event)" value="4"/>
