...
?>
<div class="filtro"><center><a href="detalhe_turma_assinatura.php?id=<?php echo $turma;?>&turno=<?php echo $p_turno?>&polo=<?php echo $p_polo?>&id_turma=<?php echo $id_turma?>">[LISTA DE ASSINATURA]</a> |<a href="javascript:window.print()">[IMPRIMIR]</a> | <a href="enturmar.php?turma=<?php echo $turma;?>&turno=<?php echo $turno;?>&polo=<?php echo $polo;?>&id_turma=<?php echo $id_turma;?>">[ENTURMAR ALUNOS]</a></center>
</div>
<div class="conteudo">
