...
<script src="http://www.google.com/jsapi"></script>
    ...
    <body >
        ...
        <div class="container_12">
                ...
                <form action="salvar_interessado.php" name="formulario" id="formulario" method="POST" onKeyPress="return arrumaEnter(this, event)">
...
<table width="100%" border="0">
  ...
  <tr>
    ...
    <td><div class="input-prepend">
	      ...
	      <option value="<?php echo $dados["civil"]; ?>">Selecione...</option>
...
<td><div class="input-prepend">
                                ...
                                <input id="rua" name="rua" type="text" value="<?php echo $dados["endereco"]; ?>" placeholder="Nome da Rua / Logradouro" required style="text-transform:uppercase" onKeyPress="return arrumaEnter(this, event)"/>
                            </div></td>
<td></td>
</tr>
<tr>
...
<tr> 
  ...
  <tr>
    ...
    <td><div class="input-prepend">
                                <span class="add-on">Rua</span>
                                <input id="rua_fin" name="rua_fin" type="text" placeholder="Nome da Rua / Logradouro" value="<?php echo $dados["end_fin"]; ?>" required style="text-transform:uppercase" onKeyPress="return arrumaEnter(this, event)"/>
                            </div></td>
  </tr>
  <tr>
    <td><div class="input-prepend">
...
<tr> 
  ...
  <tr>
    ...
    <td><div class="input-prepend">
                                <span class="add-on">Rua</span>
                                <input id="rua_fia" name="rua_fia" type="text" value="<?php echo $dados["end_fia"]; ?>" placeholder="Nome da Rua / Logradouro" style="text-transform:uppercase" onKeyPress="return arrumaEnter(this, event)"/>
                            </div></td>
  </tr>
  <tr>
    <td><div class="input-prepend">
