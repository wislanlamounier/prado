...
if($user_unidade == ""){
	...
	$sql = mysql_query("SELECT * FROM ced_turma WHERE unidade LIKE '%$user_unidade%' ORDER BY grupo,nivel, curso, modulo");
}
...
?>
<div class="conteudo">
<form id="form2" name="form1" method="post" action="filtrar_rem_turma.php">
    Grupo:
...
<table width="100%" border="1" class="full_table_list" style="font-size:12px">
	<tr>
        ...
        <td><div align="center"><strong>BOLETOS</strong></div></td>
        <td><div align="center"><strong>ADITIVOS</strong></div></td>
	</tr>
...
if ($count == 0) {
	...
	<tr>
		...
		<td><center>$polo</center></td>
		<td><a href=\"gerar_rem_turma.php?id_turma=$id_turma\" target=\"_blank\" ><center>[GERAR BOLETOS]</center></td>
		<td><a href=\"gerar_rem_turma_aditivo.php?id_turma=$id_turma\" target=\"_blank\" ><center>[GERAR ADITIVOS]</center></td>
		\n";
