...
?>
<div class="conteudo">
<div><font size="+2"><a href="listar_aulas.php?id=<?php echo $turma_d;?>&id_turma=<?php echo $id_turma;?>">Di&aacute;rio</a></font></div>
<?php
...
if ($count2 == 0) {
    ...
    while ($dados2 = mysql_fetch_array($sql2)) {
        ...
        echo "
		<td><div align=\"center\"><strong><a href=\"javascript:abrir('lancar_atividade.php?ativ=$grupo_ativi&turma=$turma_d&grupo=$grupo_turma');\">$atividade</a></strong></div></td>
	...
	<tr>
		...
		while ($dados2 = mysql_fetch_array($sql2)) {
			...
			//pesquisa notas anteriores
				...
				echo "
				<td align=\"center\"><a href=\"javascript:abrir('lancar_nota.php?td=$turma_d');\">$nota_aluno</a></b></td>";
