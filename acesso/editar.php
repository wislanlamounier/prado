...
?>
  ...
  <tr  bgcolor="#F7F7F7">
	...
	<tr  bgcolor="#F7F7F7">
	  ...
	  <td><input name="juros1" type="text" class="textBox2" id="juros1" value="<?php echo $juros1; ?>" maxlength="20"/></td>
    </tr>
    <tr  bgcolor="#F7F7F7">
      <td><strong>Juros (Por dia de Atraso)</strong></td>
      <td><input name="juros2" type="text" class="textBox2" id="juros2" value="<?php echo $juros2; ?>" maxlength="20"/></td>
    </tr>
    <tr  bgcolor="#F7F7F7">
      <td><strong>Juros (5 dias de atraso)</strong></td>
      <td><input name="juros3" type="text" class="textBox2" id="juros3" value="<?php echo $juros3; ?>" maxlength="20"/></td>
    </tr>
    <tr  bgcolor="#F7F7F7">
