...
<?php 
$sql_questionario = mysql_query("SELECT * FROM ea_questionario WHERE id_questionario = '$get_id_quest' AND grupo LIKE '%$turma_grupo%' AND unidade LIKE '%$turma_unidade%' AND nivel LIKE '%$turma_nivel%' AND curso LIKE '%$turma_curso%' AND modulo LIKE '%$turma_modulo%' AND cod_ativ = '$cod_ativ' AND 
...
if(mysql_num_rows($sql_questionario)==0){
	...
	<table class=\"full_table_cad\" border=\"1\" align=\"center\">
		...
		<tr>
			...
			<input type=\"hidden\" name=\"senha_certa\" value=\"$questionario_senha\"></td>
		<tr>
		<tr>
