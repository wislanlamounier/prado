...
?>
<div class="filtro"><center><a href="javascript:window.print()">[IMPRIMIR]</a> | <a href="enturmar.php?turma=<?php echo $turma;?>&turno=<?php echo $turno;?>&polo=<?php echo $polo;?>&id_turma=<?php echo $id_turma;?>">[ENTURMAR ALUNOS]</a></center>
</div>
<div class="conteudo">
<table width="100%" border="1" class="full_table_list" align="center">
    ...
    <th colspan="2"><center><?php echo "Ano / Módulo: ".$moduloexib; ?><br /><?php echo "[".$turma."] ".$nivel.": ".$curso;?><br /><?php echo $turno;?></center></th>
        ...
        <td style="width:30%" bgcolor="#ABABAB"><div align="center"><strong>Assinatura</strong></div></td>
	</tr>
