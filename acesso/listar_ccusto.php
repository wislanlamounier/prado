...
?>
<div class="conteudo">
<center><a href="javascript:history.back()">[VOLTAR]</a> |<a href="javascript:window.print()">[IMPRIMIR]</a></center>
...
if ($count == 0) {
    ...
    while ($dados = mysql_fetch_array($sql)) {
        ...
        echo "
	<tr bgcolor='$cor'>
		<td bgcolor='$cor' align='center'>&nbsp;<a href=\"javascript:abrir('editar_ccusto.php?id=$id_titulo&id2=$id_custo')\">$id_titulo</a></td>
