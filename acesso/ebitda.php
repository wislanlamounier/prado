...
<div class="conteudo">
<form id="form1" name="form1" method="get" action="listar_ebitda.php">
  ...
  <tr>
    ...
    <td align="center"><select name="cc1" class="textBox" id="cc1" onkeypress="return arrumaEnter(this, event)">
...
?>
  ...
  <tr>
    <td>EBITDA:</td>
    <td><select name="ebitda" class="textBox" id="ebitda" onkeypress="return arrumaEnter(this, event)">
