...
if($user_unidade == ""){
	$sql = mysql_query("SELECT * FROM ced_turma ORDER BY grupo,nivel, curso, modulo");
} else {
	$sql = mysql_query("SELECT * FROM ced_turma WHERE unidade LIKE '%$user_unidade%' ORDER BY grupo,nivel, curso, modulo, unidade, polo");
}
...
if ($count == 0) {
    ...
    while ($dados = mysql_fetch_array($sql)) {
        ...
        echo "
	<tr>
		<td><a href=\"disciplinas_turma.php?id=$codigo&grade=$grupo&turno=$turno&polo=$polo&id_turma=$id_turma\"><b><center>$codigo</b></center></a></td>
		<td><a href=\"disciplinas_turma.php?id=$codigo&grade=$grupo&turno=$turno&polo=$polo&id_turma=$id_turma\">$nivel</td>
		<td><a href=\"disciplinas_turma.php?id=$codigo&grade=$grupo&turno=$turno&polo=$polo&id_turma=$id_turma\"><center>$curso</center></td>
		<td><a href=\"disciplinas_turma.php?id=$codigo&grade=$grupo&turno=$turno&polo=$polo&id_turma=$id_turma\"><center>$modulo</center></td>
		<td><a href=\"disciplinas_turma.php?id=$codigo&grade=$grupo&turno=$turno&polo=$polo&id_turma=$id_turma\"><center>$turno</center></td>
		<td><a href=\"disciplinas_turma.php?id=$codigo&grade=$grupo&turno=$turno&polo=$polo&id_turma=$id_turma\"><center>$grupo</center></td>
		<td><a href=\"disciplinas_turma.php?id=$codigo&grade=$grupo&turno=$turno&polo=$polo&id_turma=$id_turma\"><center>$unidade</center></td>
		<td><a href=\"disciplinas_turma.php?id=$codigo&grade=$grupo&turno=$turno&polo=$polo&id_turma=$id_turma\"><center>$polo</center></td>
		\n";
