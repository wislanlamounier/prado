...
$re    = mysql_query("select count(*) as total FROM titulos WHERE id_titulo LIKE '$codigo'");	
$total = mysql_result($re, 0, "total");

if($total == 1) {
	$re    = mysql_query("SELECT * FROM titulos WHERE id_titulo LIKE '$codigo'");
	...
	if($dados["vencimento"] < $atual&&$recebido ==""){
