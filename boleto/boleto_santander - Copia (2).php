...
$alunonome = strtoupper(utf8_encode($dadosaluno["nome"]));
$responsavel = strtoupper(utf8_encode($dadosaluno["nome_fin"]));
...
$dadosboleto["demonstrativo1"] = "<b>Aluno:</b> $alunonome <br>- Para pagamento até o dia $diadesconto/$mes/$ano receber valor de R$ $valor_boleto_desconto.  ";
