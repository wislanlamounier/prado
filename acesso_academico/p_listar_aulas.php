...
$turma_pesq2 = mysql_query("SELECT * FROM ced_turma WHERE cod_turma LIKE '$cod_turma' AND id_turma = $id_turma");
...
$nome_disciplina = utf8_decode($dados_disc["disciplina"]);
...
<div><font size="+2"><a href="p_aluno_turma.php?id=<?php echo $turma_d;?>&id_turma=<?php echo $id_turma;?>">NOTAS</a></font></div>
...
<table width="100%" border="1" class="full_table_list" style="font-size:10px; font-family:Arial, Helvetica, sans-serif;">
  ...
  <tr>
    ...
    <td><b>Turma:<br /><a href="javascript:abrir('p_detalhe_turma.php?id=<?php echo $cod_turma;?>&turno=<?php echo $turno_turma;?>&polo=<?php echo $polo_turma;?>&id_turma=<?php echo $id_turma;?>');" ><?php echo $cod_turma;?></a></b></td>
    </tr>
    <tr>
...
if ($count == 0) {
    ...
    while ($ch_contar <= $ch_disciplina) {
		...
		if($exibir_data =="//"){
			$exibir_data = "----";
			$exibir_frequencia = "AULA N&Atilde;O LAN&ccedil;ADA";
		} else {
			$exibir_frequencia = "<a href=\"javascript:abrir('p_lancar_falta.php?n_aula=$ch_contar&data_aula=$exibir_data2&td=$turma_d')\">[FREQUÊNCIA]</a></div>";
		}
        // enquanto houverem resultados...
        echo "<tr>
		<td><div align=\"center\"><font size=\"+1\"><strong><a href=\"javascript:abrir('p_cad_aula.php?cod_disc=$cod_disciplina&ano_grade=$grade_disciplina&aula=$ch_contar&td=$turma_d&prof=$nome_professor&disciplina=$nome_disciplina&curso=$curso_turma');\">$ch_contar</a></font></strong></div></td>
		<td><div align=\"center\"><font size=\"+1\"><b>$exibir_data</b></font></div></td>
		<td><div align=\"center\">$exibir_frequencia</td>
		<td><div align=\"center\"><a href=\"javascript:abrir('p_exibir_diario.php?id=$turma_d&id_turma=$id_turma')\">[FREQU&Ecirc;NCIA]</a> | <a href=\"javascript:abrir('p_exibir_notas.php?id=$turma_d&id_turma=$id_turma')\">[NOTAS]</a> | <a href=\"javascript:abrir('p_exibir_conteudo.php?id=$turma_d&id_turma=$id_turma')\">[CONTE&Uacute;DO]</a> </div></td>
		</tr>
		\n";
		$ch_contar +=1;
