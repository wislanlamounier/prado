	...
	$total = mysql_num_rows($pesquisar);
		while($dados_ativ = mysql_fetch_array($pesquisar)){
			...
			if($cod_ativ == "1000"){
				...
				$excluir_ativ = "<br><font-size='-2'><a href=\"p_excluir_atividade.php?id=$ref_id\">[EXCLUIR]</font></a>";
			}
			echo "<td><center><a href=\"#\" title=\"$desc_ativ\"><b>$nome_atividade<br><font size='-1'>($data_ativ)</font></b></a></center>$excluir_ativ</td></center>";
			}
...
<?php
		...
		echo "<td align=\"center\"><input $ativ_bloq type=\"text\" name=\"nota[]\" id=\"nota[]\" value=\"$nota_aluno\" style=\"width:50px\" /> <b> | <font color=\"red\">$valor_ativ</font></b>
			<input type=\"hidden\" $ativ_bloq name=\"mat_aluno[]\" id=\"mat_aluno[]\" value=\"$codigo\" />
			<input type=\"hidden\" $ativ_bloq name=\"ref_ativ[]\" id=\"ref_ativ[]\" value=\"$ref_id\" />
			<input type=\"hidden\" $ativ_bloq name=\"cod_t_d[]\" id=\"cod_t_d[]\" value=\"$turma_disc\" />
			<input type=\"hidden\" $ativ_bloq name=\"grupoativ[]\" id=\"grupoativ[]\" value=\"$grupo_ativ\" />
			<input type=\"hidden\" $ativ_bloq name=\"maxnota[]\" id=\"maxnota[]\" value=\"$valor_ativ\" />
			</td>";
		}
